            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="ps-3">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalAgregarPromocion">Agregar usuario</button>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Elliminar</th>
                            ...
                            <tbody>
                                @foreach($sql as $promocion)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalEditarPromocion{{$promocion->ID_Precio}}">Editar</button>
