        ...
        <div class="card-body p-3">
            <div class="row gx-4">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1">
                            {{ auth()->user()->nombre ?? 'nombre' }} {{ auth()->user()->primerApellido ?? 'primerApellido' }} {{ auth()->user()->segundoApellido ?? 'segundoApellido' }}
                        </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="primerApellido" value="{{ old('primerApellido', auth()->user()->primerApellido) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center mt-4">
                            <h5>
                                {{ old('nombre', auth()->user()->nombre) }}<span class="font-weight-light">, 35</span>
                            </h5>
